...
Open a [GitHub issue](https://github.com/ggfevans/github-json-bourne/issues/new) with:
...
Open an issue describing the use case. This action is intentionally minimal -- it fetches data from GitHub and writes JSON. Features that add complexity without broad utility may not be accepted.
